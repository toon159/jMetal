...
import org.uma.jmetal.algorithm.multiobjective.nsgaiii1.NSGAIII1Builder;
 ...
 */
public class NSGAIII1Runner extends AbstractAlgorithmRunner {
    /**
...
//        selection = new BinaryTournamentSelection<DoubleSolution>();
        ...
        algorithm = new NSGAIII1Builder<>(problem)
