...
import org.uma.jmetal.algorithm.multiobjective.nsgaiii3.util.EnvironmentalSelection;
import org.uma.jmetal.algorithm.multiobjective.nsgaiii3.util.ReferencePoint;
...
public class NSGAIII3<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
  ...
  /** Constructor */
  public NSGAIII3(NSGAIII3Builder<S> builder) { // can be created from the NSGAIIIBuilder within the same package
