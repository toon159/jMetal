...
import org.uma.jmetal.algorithm.multiobjective.nsgaiii2.util.EnvironmentalSelection;
import org.uma.jmetal.algorithm.multiobjective.nsgaiii2.util.ReferencePoint;
...
public class NSGAIII2<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
  ...
  /** Constructor */
  public NSGAIII2(NSGAIII2Builder<S> builder) { // can be created from the NSGAIIIBuilder within the same package
