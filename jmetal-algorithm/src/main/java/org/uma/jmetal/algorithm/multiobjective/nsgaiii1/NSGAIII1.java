...
import org.uma.jmetal.algorithm.multiobjective.nsgaiii1.util.EnvironmentalSelection;
import org.uma.jmetal.algorithm.multiobjective.nsgaiii1.util.ReferencePoint;
...
public class NSGAIII1<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
  ...
  /** Constructor */
  public NSGAIII1(NSGAIII1Builder<S> builder) { // can be created from the NSGAIIIBuilder within the same package
